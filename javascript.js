  ...
  function drawChart() {
	...
	[1, 'CorentinJ', 'Real-Time-Voice-Cloning', 282],
     	[2, 'ChristianChiarulli', 'LunarVim', 1388],
     	...
     	[10, 'go-kratos', 'kratos', 1034],
     	[11, 'NationalSecurityAgency', 'ghidra', 4992],
     	[12, 'snowpackjs', 'astro', 841],
     	[13, 'ultralytics', 'yolov5', 1340],
     	[14, 'YMFE', 'yapi', 5747],
     	[15, 'JDHelloWorld', 'jd_scripts', 208],
     	[16, 'mui-org', 'material-ui', 17258],
     	[17, 'airbnb', 'javascript', 1875],
     	[18, 'microsoft', 'vscode', 85602],
     	[19, 'apache', 'airflow', 12979],
