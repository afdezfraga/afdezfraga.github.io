  ...
  function drawChart() {
	...
	[1, 'alievk', 'avatarify-python', 351],
     	...
     	[22, 'Ryujinx', 'Ryujinx', 1566],
     	[23, 'ethereum-mining', 'ethminer', 14334],
     	[24, 'Immediate-Mode-UI', 'Nuklear', 1863],
     	[25, 'spring-projects-experimental', 'spring-native', 1871],
