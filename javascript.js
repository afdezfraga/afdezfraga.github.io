  ...
  function drawChart() {
	...
	[1, 'CorentinJ', 'Real-Time-Voice-Cloning', 282],
     	[2, 'ChristianChiarulli', 'LunarVim', 1355],
     	[3, 'mirumee', 'saleor', 18742],
     	[4, 'bradtraversy', '50projects50days', 90],
     	[5, 'microsoft', 'Web-Dev-For-Beginners', 997],
     	[6, 'OpenXiangShan', 'XiangShan', 5891],
     	[7, 'input-output-hk', 'plutus-pioneer-program', 161],
     	[8, 'inancgumus', 'learngo', 495],
     	[9, 'MustangYM', 'WeChatExtension-ForMac', 1024],
     	[10, 'go-kratos', 'kratos', 1028],
     	[11, 'NationalSecurityAgency', 'ghidra', 4992],
     	[12, 'snowpackjs', 'astro', 841],
     	[13, 'ultralytics', 'yolov5', 1336],
     	[14, 'YMFE', 'yapi', 5747],
     	[15, 'JDHelloWorld', 'jd_scripts', 205],
     	[16, 'mui-org', 'material-ui', 17256],
     	[17, 'airbnb', 'javascript', 1875],
     	[18, 'microsoft', 'vscode', 85599],
     	[19, 'apache', 'airflow', 12971],
     	[20, 'trekhleb', 'javascript-algorithms', 953],
     	[21, 'JetBrains', 'kotlin', 84360],
     	[22, 'tiangolo', 'fastapi', 1702],
     	[23, 'labuladong', 'fucking-algorithm', 288],
     	[24, 'Snailclimb', 'JavaGuide', 3262],
